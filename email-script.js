    ...
    function renderSectionControls(variant) {
        ...
        return `
            ...
            <div class="section-controls">
                ...
                ${hasLayoutToggle ? '<button class="control-btn layout-btn" aria-label="Toggle layout direction">Toggle Layout</button>' : ''}
    ...
    function setupEventListeners() {
        ...
        if (sectionLibrary) {
            ...
            if (btn && !btn.disabled) {
                ...
                const heroVariant = btn.dataset.variant; // Get hero variant
                ...
                // Call addSection with hero variant
                if (sectionType === 'hero' && heroVariant) {
                    addSection(sectionType, heroVariant);
                } else {
